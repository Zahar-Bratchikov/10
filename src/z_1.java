...
public class z_1 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String c = vvodstr();
        FileWriter writer = new FileWriter("text1.txt", true);
        PrintWriter printer = new PrintWriter(writer);
        printer.println("\nРезультаты обработки массива:");

        printer.printf("а) Кол-во строчных русских букв %d\n", a(arr));
        ...
        if (e(arr)) {
            printer.println("д) В последовательности есть более двух подряд идущих пробелов");
        } else {
            printer.println("д) В последовательности нет более двух подряд идущих пробелов");
        }
